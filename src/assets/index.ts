...
import PlaylistsLogo from "./playlist.svg";
...
export { MenuLogo, ClockLogo, HeartLogo, HomeLogo, PlaylistsLogo, UploadLogo, BackArrow, HistoryLogo, DeleteLogo, GoogleLogo }
